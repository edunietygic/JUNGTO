      ...
      <?if(isset($aData['aCourseList']) && count($aData['aCourseList']->oActiveCourse) >=1 ) :?>
        ...
        <div class="post-item border">
          <div class="post-item-wrap">
            <div class="post-image"> <!--a href="javascript:;" data-target="#modal-3" data-toggle="modal"--> <img alt="" src="<?=$val->img?>"> <!--/a--> <?php if($val->part) : ?> <span class="post-meta-category"><?=$val->part?></span><?php endif;?> </div>
