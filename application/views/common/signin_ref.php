		...
		<!-- <div class="row">
			<div class="col-md-12">
				<div class="form-group text-center">
					<button class="btn btn-default btn-submit btn-block" type="button">가입하기</button>
				</div>
			</div>
		</div> -->
	</form>
...
<div class="modal-footer">
	<button type="button" class="btn btn-default btn-block" type="button" onclick="signin();">가입하기</button>
</div>
